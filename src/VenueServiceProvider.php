...
class VenueServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('blupl/venue', 'blupl/venue', $path.'/resources/config');
        $this->addLanguageComponent('blupl/venue', 'blupl/venue', $path.'/resources/lang');
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Blupl\Venue\Http\Handlers\VenueMenuHandler');
    }
